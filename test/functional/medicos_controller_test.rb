...
class MedicosControllerTest < ActionController::TestCase
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post :create, medico: { apellidos: @medico.apellidos, celular: @medico.celular, dni: @medico.dni, nombres: @medico.nombres }
    end
  ...
  test "should update medico" do
    put :update, id: @medico, medico: { apellidos: @medico.apellidos, celular: @medico.celular, dni: @medico.dni, nombres: @medico.nombres }
    assert_redirected_to medico_path(assigns(:medico))
  end
